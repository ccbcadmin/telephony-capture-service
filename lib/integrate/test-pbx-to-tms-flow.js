...
util_1.sleep(2000)
    .then(tmsQueue.purge)
    .then(() => client_socket_1.createClient("pbx=>tcs", "localhost", env.TCS_PORT, sendData, linkClosed))
...
util_1.sleep(600000).then(() => { console.log("Insufficient Data Received: ", rxBytes); process.exit(1); });
