...
let smdrMsgsSent = 0;
let tcsClient;
const sendSmdrRecords = (smdrFileName) => __awaiter(this, void 0, void 0, function* () {
    try {
...
const checkRecordCount = () => __awaiter(this, void 0, void 0, function* () {
    try {
...
const nextFile = () => __awaiter(this, void 0, void 0, function* () {
    try {
