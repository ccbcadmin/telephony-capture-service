...
tmsQueue = env.TMS_ACTIVE ? new queue_1.Queue(env.TMS_QUEUE, null, tmsQueueDisconnectHandler) : null;
databaseQueue = new queue_1.Queue(env.DB_QUEUE, null, dbQueueDisconnectHandler, dbQueueConnectHandler);
