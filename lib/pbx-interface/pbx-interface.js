...
const server_socket_2 = require('../share/server-socket');
...
(function (TelephonyCaptureService) {
    ...
    console.log('networdIP: ', util_2.networkIP);
    new server_socket_2.ServerSocket(routineName, util_2.networkIP, env.TCS_PORT, dataSink);
