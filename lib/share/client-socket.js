...
exports.createClient = (linkName, host, port, connectHandler = null, disconnectHandler = null) => new Promise((resolve) => resolve(new ClientSocket(linkName, host, port, connectHandler, disconnectHandler)));
