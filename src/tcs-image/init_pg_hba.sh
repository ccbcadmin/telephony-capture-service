...
{ echo; echo "host all all 192.168.0.1/16 md5"; } | gosu postgres tee -a "$PGDATA/pg_hba.conf" > /dev/null
{ echo; echo "host replication all 192.168.0.1/16 md5"; } | gosu postgres tee -a "$PGDATA/pg_hba.conf" > /dev/null
